...
public class BalanceService {
    ...
    public void addBalance(String cardNum, String amount, int flowType) {
        backService.processBalance(cardNum, amount, flowType, true);
    }

    public void subBalance(String cardNum, String amount, int flowType) {
        processBalance(cardNum, amount, flowType, false);
    }
